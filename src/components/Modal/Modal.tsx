...
import { useCreateData, useDeleteData } from '../PlatziAPI/PlatziAPI';
...
const Modal: React.FC<ModalProps> = ({ open, onClose, children }) => {
  ...
  const deleteDataMutation = useDeleteData(queryClient);
  const createDataMutation = useCreateData(queryClient)
